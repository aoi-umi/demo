...
exports.save = function (params, conn) {
	var sql = 'call p_log_save_auto(:id, :url, :method, :result, :code, :req, :res, :create_date, :remark, :null_list)';
	if(!conn)
...
exports.query = function (params, conn) {
	var sql = 'call p_log_query_auto(:id, :url, :method, :result, :code, :req, :res, :create_date, :remark, :null_list, :page_index, :page_size)';
	if(!conn)
		return db.query(sql, params);
	else
		return db.tranQuery(sql, params, conn);
