...
exports.save = function(params, conn) {
	var sql = 'call p_main_content_save_auto(:id, :type, :status, :user_info_id, :title, :desc, :create_date, :operate_date, :operator, :null_list)';
...
exports.query = function(params, conn) {
	var sql = 'call p_main_content_query_auto(:id, :type, :status, :user_info_id, :title, :desc, :create_date, :operate_date, :operator, :null_list, :page_index, :page_size)';
	return db.query(sql, params, conn);
};
