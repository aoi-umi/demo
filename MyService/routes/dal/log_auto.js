...
exports.save = function(params, conn) {
	var sql = 'call p_log_save_auto(:id, :url, :method, :result, :code, :req, :res, :ip, :create_date, :remark, :guid, :duration, :null_list)';
...
exports.query = function(params, conn) {
	var sql = 'call p_log_query_auto(:id, :url, :method, :result, :code, :req, :res, :ip, :create_date, :remark, :guid, :duration, :null_list, :page_index, :page_size)';
	return db.query(sql, params, conn);
};
